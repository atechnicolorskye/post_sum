...
# Import data
data = pd.read_pickle("../../ff5_30_standard_4000_draws.pkl")
...
#     np.save("obj_lin_long_ff5_ip30_" + str(max_iter) + "_rho_1e2_mult_1.1_" + str(weights[0]) + "_m_50_eps_2.npy", tgl_tpe.obj)
#     np.save("lin_long_ff5_ip30_" + str(max_iter) + "_rho_1e2_mult_1.1_" + str(weights[0]) + "_m_50_eps_2.npy", pre_tpe)
...
#     np.save("obj_grad_long_ff5_ip30_" + str(max_iter) + "_rho_1e2_mult_1.1_" + str(weights[0]) + "_m_50_eps_2.npy", tgl_g.obj)
#     np.save("grad_long_ff5_ip30_10000_rho_1e2_mult_1.1_" + str(weights[0]) + "_m_50_eps_2.npy", pre_g)
...
#     # print('Vanilla Max', np.max(np.array(fit_score_tgl_thres[1e-4]) - baseline_score_g))
...
#     # plt.tight_layout()
#     # plt.savefig('ff5_ip30_10000_long_' + str(weights[0]) + '_diff_like.pdf')
...
#     # fig.legend(fontsize=20, loc='lower left', bbox_to_anchor=(0.05, 0.08, 0.5, 0.5))
#     # ax.set_ylabel('Support', fontsize=25)
#     # ax.tick_params(axis='both', which='major', labelsize=20)
#     # ax.set_xlabel('Time t', fontsize=25)
#     # ax.set_title(r'Support for Empirical Inverse and Constrained ADMM', fontsize=30)
#     # plt.tight_layout()
#     # plt.savefig('ff5_ip30_10000_long_' + str(weights[0]) + '_diff_support.pdf')


#     # fig, ax = plt.subplots(figsize=(20, 10))
#     # fig.patch.set_facecolor('white')

#     # diff = [norm(pre_tgl[1e-4][t] - pre_tgl[1e-4][t-1], 'fro') for t in range(1, X_cov.shape[-1])]
#     # mean_diff = np.mean(diff)
#     # ax.plot(range(1, X_cov.shape[-1]), diff, color='r', alpha=0.5, 
#     #         label=r'TGL, Mean Diff = {:.3f}'.format(1e-4, mean_diff))
...
#     # ax.tick_params(axis='both', which='major', labelsize=20)
#     # ax.set_xlabel('Time t', fontsize=25)
#     # ax.set_title(r'Difference in Frobenius Norm for Constrained ADMM', fontsize=30)
#     # plt.tight_layout()
#     # plt.savefig('ff5_ip30_10000_long_' + str(weights[0]) + '_diff_fro.pdf')
